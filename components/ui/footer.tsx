        ...
        <div className="py-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between mb-4">
            <div className="shrink-0 mr-4">
              ...
              <Link className="inline-flex group mb-8 md:mb-0" href="/" aria-label="Cruip">
                <Image src={Logo} width={120} alt="Community" />
              </Link>
            </div>
            {/* Right links */}
          ...
          <div className="text-center md:flex md:items-center md:justify-between">
            ...
            <ul className="inline-flex mb-4 md:order-1 md:ml-4 md:mb-0 space-x-2">
              <li>
                <a
                  className="flex justify-center items-center text-sky-400 hover:text-sky-200 transition duration-150 ease-in-out"
                  href="https://twitter.com/icphub_UK"
                  aria-label="Twitter"
                >
            ...
            {/* Copyright */}
            <div className="text-sm text-slate-600">Copyright © ICP Hub UK. Designed by M51 Creative.</div>
          </div>
        </div>
      </div>
    </footer>
